class Restaurant {
    ...
    public void prepareFood() { System.out.println(name + " is preparing generic food"); }
    public void estimateTime() { System.out.println("Estimated time: 30 minutes"); }
}
...
class PizzaPlace extends Restaurant {
    ...
    @Override public void estimateTime() { System.out.println("Pizza ready in 20 minutes!"); }
}
...
class SushiBar extends Restaurant {
    ...
    @Override public void estimateTime() { System.out.println("Sushi will be ready in 25 minutes!"); }
}

public class FoodDelivery {
    public static void main(String[] args) {
        Restaurant r = new PizzaPlace("Mario's Pizza");
        r.prepareFood(); r.estimateTime();
