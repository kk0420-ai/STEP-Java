...
public class ATMDemo {
    public static void main(String[] args) {
        BankAccount account = new BankAccount("123456789", 10000, 1234);
        ATM atm = new ATM(account);
        Customer customer = new Customer("Ravi", atm);

        customer.performWithdrawal(1234, 3000);  // Correct PIN
        customer.performWithdrawal(9999, 1000);  // Incorrect PIN
    }
}
